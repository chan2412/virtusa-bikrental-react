...
class BookingcontrollerTest {
	Logger logger = LogManager.getLogger(BookingcontrollerTest.class);
	@InjectMocks
	...
	void testGetAllBookings() {
		...
		Bookingmodel booking1 = new Bookingmodel("1", "user", "r15", "admin@gmail.com", "company", "1", "20", "2",
				"400");
		Bookingmodel booking2 = new Bookingmodel("2", "user1", "activa 5g", "admin@gmail.com", "company", "2", "15",
				"2", "300");
	...
	void testGetMyBookings() {
		...
		Bookingmodel booking1 = new Bookingmodel("1", "user", "r15", "admin@gmail.com", "company", "1", "20", "2",
				"400");
		Bookingmodel booking2 = new Bookingmodel("2", "user", "activa 5g", "admin1@gmail.com", "company", "2", "15",
				"2", "300");
		bookings.add(booking1);
		bookings.add(booking2);
