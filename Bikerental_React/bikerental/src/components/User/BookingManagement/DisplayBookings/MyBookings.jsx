...
import { fetchMyBookings } from '../../../../functions/User/BookingManagement/MyBookings';
...
function MyBookings() {
  ...
  useEffect(() => {
    ...
    fetchMyBookings().then((fetchedBookings) => {
  ...
  return (
    <div>
      ...
      <TableContainer className="MyBooking-Table" component={Paper}>
